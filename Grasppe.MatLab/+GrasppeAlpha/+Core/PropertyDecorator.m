classdef PropertyDecorator < GrasppeAlpha.Core.Prototype % & GrasppeAlpha.Core.HandleComponent
  ...
  methods(Static, Hidden)
    function preSetDecoratorProperty(source, event)
      ...
      if GrasppeAlpha.Core.PropertyDecorator.checkInheritence(obj) && isvalid(obj)

classdef Property < GrasppeAlpha.Core.Prototype
...
%       end
%       obj = GrasppeAlpha.Core.Property(Component, Name, Alias, DisplayName, Description, Type, EditorContext, Category, Editable, Value, MetaProperty, MetaMediation);
%     end
  end

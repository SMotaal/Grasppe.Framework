function [f, gr1, gr2, gr3, gr4]=TestVectorClasses()
...
% USE BIGDECIMAL
dum=kcl.waterloo.graphics.data.GJBigDecimalDataVector();
clzz=dum.getClass();
kcl.waterloo.defaults.GJDefaults.setDataClass(clzz);
a1=line(gxgca, x, y, 'LineSpec', '-ob');
% USE DOUBLE
dum=kcl.waterloo.graphics.data.GJDoubleDataVector();
clzz=dum.getClass();
kcl.waterloo.defaults.GJDefaults.setDataClass(clzz);
b1=line(gxgca, x, y*2, 'LineSpec', '-sg');
% USE FLOAT
dum=kcl.waterloo.graphics.data.GJFloatDataVector();
clzz=dum.getClass();
kcl.waterloo.defaults.GJDefaults.setDataClass(clzz);
c1=line(gxgca, x, y*5, 'LineSpec', '-dr');
% USE PRIMITIVE
dum=kcl.waterloo.graphics.data.GJPrimitiveDoubleDataVector();
clzz=dum.getClass();
kcl.waterloo.defaults.GJDefaults.setDataClass(clzz);
...
disp('Test3.xml');
kcl.waterloo.xml.GJEncoder.save(fullfile(tempdir,'Test3.kclf'), gr3.getObject().hgcontrol);
if (kcl.waterloo.xml.GJEncoder.getExceptionLog().size()>0); disp(kcl.waterloo.xml.GJEncoder.getExceptionLog());end;

disp('Test4.xml');
kcl.waterloo.xml.GJEncoder.save(fullfile(tempdir,'Test4.kclf'), gr4.getObject().hgcontrol);
if (kcl.waterloo.xml.GJEncoder.getExceptionLog().size()>0); disp(kcl.waterloo.xml.GJEncoder.getExceptionLog());end;

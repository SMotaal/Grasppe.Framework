classdef (Sealed) InstanceTable < handle  % containers.Map
  ...
  methods (Static)  % Instance Functions
    function id = RegisterInstance(id, instance)
      ...
      if isempty(id), id  = Grasppe.Prototypes.InstanceTable.GenerateInstanceID(class(instance)); end
      ...
      instanceRecord  = Grasppe.Prototypes.InstanceTable.CreateInstanceRecord(id, instance);

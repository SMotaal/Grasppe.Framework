...
function value = convertBooleanFromHandleValue(value)
  ...
  %value   = Grasppe.Prototypes.Enumerations.HandleBoolean(value);
end

function value = convertBooleanToHandleValue(value)
  
  switch class(value)
    case 'Grasppe.Prototypes.Enumerations.HandleBoolean'
      value = char(value);
    case 'logical'
      value = char(Grasppe.Prototypes.Enumerations.HandleBoolean(value));
  end
